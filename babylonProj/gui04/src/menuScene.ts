...
import {
  ...
  export default function menuScene(engine: Engine) {
    ...
    let textBG = createRectangle(scene, "300px", "100px", "0px", "-200px", 20, "red", 4, "blue", advancedTexture);
    let titleText = createText(scene, "THE GAME", "0px", "-200px", "45", "green", advancedTexture);
